    ...
    react.useEffect(() => {
        ...
        if (pluginHelper) {
            ...
            fetch(`${window.location.origin}/identityiq/ui/rest/requestAccess/identities/suggest/object/sailpoint.object.Identity`, {
                ...
                setUserEmail((_b = resp === null || resp === void 0 ? void 0 : resp.objects[0]) === null || _b === void 0 ? void 0 : _b.email);
            }))
                .then((json) => console.log(json));
        }
    });
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsx("div", Object.assign({ style: { padding: "20px" } }, { children: `Hello ${userName}.Your email is ${userEmail}` })) }));
}
